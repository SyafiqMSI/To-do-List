...
public class Register extends javax.swing.JFrame {
    ...
    private void createTextFile(String email) {
        try {
            // Create a new text file with the user's email as the filename
            File userFile = new File(email + ".txt");
            userFile.createNewFile();

            // You can perform additional operations like writing user information to the file
            // For example, writing the password (Note: In a real-world scenario, you should hash the password)
