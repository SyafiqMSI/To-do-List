...
public class Register extends javax.swing.JFrame {
    ...
    private void doRegister() {
        ...
        if (!isValidLogin(email, password)){
            JOptionPane.showMessageDialog(this, "Email harus mengandung \"@\" dan password (a-z, 0-9, maksimal 8 digit)");
    ...
    private boolean isValidLogin(String email, String password) {
        // Validasi email hanya mengandung karakter '@'
        boolean isValidEmail = email.contains("@");

        // Validasi password sesuai kriteria (a-z, 0-9, maksimal 8 digit)
        boolean isValidPassword = isValidPassword(password);

        // Kembalikan hasil validasi email dan password
    ...
    private boolean isValidPassword(String password) {
        ...
        return password.matches("[a-zA-Z0-9]{8,100}");
    }
    ...
    private void initComponents() {
        ...
        registButton.setBackground(new java.awt.Color(102, 153, 255));
        registButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        registButton.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                registButtonKeyPressed(evt);
            }
        });
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(registButton, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void registButtonKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_registButtonKeyPressed
        doRegister();
    }//GEN-LAST:event_registButtonKeyPressed
