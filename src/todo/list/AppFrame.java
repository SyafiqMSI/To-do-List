...
public class AppFrame extends JFrame {
    ...
    private JButton clear;
       ...
       private Task task; // Assuming there's a Task instance in AppFrame
    ...
    public void addListeners() {
        ...
        clear.addMouseListener(new MouseAdapter() {
            ...
            JButton historyButton = footer.getHistory();
//            historyButton.addActionListener(e -> footer.showHistoryDialog());
